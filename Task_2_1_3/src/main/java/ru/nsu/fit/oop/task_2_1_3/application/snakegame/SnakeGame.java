package ru.nsu.fit.oop.task_2_1_3.application.snakegame;
...
import ru.nsu.fit.oop.task_2_1_3.snakegame.sprite.board.Board;
...
import ru.nsu.fit.oop.task_2_1_3.snakegame.sprite.wall.Wall;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.game.GameController;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.game.GameFX;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.sprite.BoardFX;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.skin.Skin;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.sprite.FruitFX;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.sprite.SnakeFX;
import ru.nsu.fit.oop.task_2_1_3.snakegamefx.sprite.WallFX;
...
public class SnakeGame {
    ...
    private void setImages() {
        ...
        images.put("board", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/board/board.png"))));
        images.put("head", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/snake/head.png"))));
        images.put("rotated", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/snake/rotated.png"))));
        images.put("straight", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/snake/straight.png"))));
        images.put("tail", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/snake/tail.png"))));
        images.put("apple", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/images/fruit/apple.png"))));
    }
    ...
    private void setScene() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ru/nsu/fit/oop/task_2_1_3/fxml/snakeGame.fxml"));
        try {
