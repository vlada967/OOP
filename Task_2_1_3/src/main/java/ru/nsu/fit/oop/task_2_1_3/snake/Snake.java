package ru.nsu.fit.oop.task_2_1_3.snake;

import javafx.scene.canvas.GraphicsContext;
import javafx.scene.image.ImageView;
import ru.nsu.fit.oop.task_2_1_3.direction.Direction;
import ru.nsu.fit.oop.task_2_1_3.skin.SnakeSkin;
import ru.nsu.fit.oop.task_2_1_3.sprite.Flake;
import ru.nsu.fit.oop.task_2_1_3.sprite.Head;
import ru.nsu.fit.oop.task_2_1_3.sprite.Sprite;
import ru.nsu.fit.oop.task_2_1_3.sprite.Tail;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.Stream;

import static ru.nsu.fit.oop.task_2_1_3.direction.Direction.*;
